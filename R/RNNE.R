...
#' @description This function trains an ensemble of random neural networks using balanced bootstrapped data
...
RNNE <- function(formula, train, mtry = 1, total.nets = 1, verbose = FALSE, n.cores = 1) {
  
  # Trains an ensemble of random neural networks using balanced bootstrapped data
  #
  # Args:
  #   formula    : Formula used for model, e.g. y~x1+x2+x3
  #   train      : Training data set
  #   mtry       : Number of randomly selected variables to try for each individual neural network
